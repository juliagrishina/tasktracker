...
Система использует нативную визуальную лексику iOS: системные шрифты, React Native-экраны с иерархической навигацией, карточки со скруглениями, системные меню и sheets, стандартные подтверждения опасных действий. Цвет не используется для различения проектов.
...
```mermaid
flowchart LR
    UI["React Native-экраны"] --> UseCases["Доменные use cases"]
    UseCases --> Store["Локальное SQLite-хранилище"]
