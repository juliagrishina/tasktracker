...
для iPhone и обязательный браузерный прототип. В development-режиме приложение
автоматически показывает тестовые задачи во всех разделах и сохраняет их на iPhone
в SQLite. В браузере данные живут только в памяти текущей страницы.
...
Откройте адрес Expo из консоли. В web-версии показаны тестовые карточки для
